...
class Migration(migrations.Migration):
    ...
    replaces = [('supporting_system', '0001_initial'), ('supporting_system', '0002_rename_descritpion_field_of_study_description'), ('supporting_system', '0003_characteristics_fit_alter_field_of_study_study_mode_and_more'), ('supporting_system', '0004_rename_attribiute_characteristics_attribute'), ('supporting_system', '0005_rename_attribiutes_attributes_and_more'), ('supporting_system', '0006_roomprice')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_mode', models.CharField(choices=[('Stacjonarne', 'Stacjonarne'), ('Niestacjonarne', 'Niestacjonarne'), ('Stacjonarne i niestacjonarne', 'Stacjonarne i niestacjonarne')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='supporting_system.attribiutes')),
                ('field_of_study', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='supporting_system.field_of_study')),
                ('fit', models.FloatField(default=0.0, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attribute', models.CharField(default='Nieznana cecha', max_length=120)),
            ],
            options={
